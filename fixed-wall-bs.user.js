// ==UserScript==
// @name        wallbs-pda
// @namespace   seintz.torn.wallbs-pda
// @version     1.12
...
// @downloadURL https://update.greasyfork.org/scripts/497239/wallbs-pda.user.js
// @updateURL https://update.greasyfork.org/scripts/497239/wallbs-pda.meta.js
// ==/UserScript==
...
function loadTSFactions(id) {
  ...
  const URL = `https://www.tornstats.com/api/v2/${apiKey}/spy/faction/${id}`;
